<%@ Page Title="Search" Language="C#" MasterPageFile="~/Developer.Master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="Scrum.Accounts.Developer.Search" %>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click" OnClientClick="pleaseWait();" Width="10%" BackColor="green" />
                        ...
                        <div id="table">
                            <asp:GridView ID="grdResults" runat="server" Width="100%" HorizontalAlign="Center" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" PageSize="10" AllowPaging="True" OnPageIndexChanging="grdResults_PageIndexChanging">
