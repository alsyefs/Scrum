<%@ Page Title="" Language="C#" MasterPageFile="~/Developer.Master" AutoEventWireup="true" CodeBehind="ViewProject.aspx.cs" Inherits="Scrum.Accounts.Developer.ViewProject" %>
            ...
            <div class="panel-body">
                ...
                <asp:UpdatePanel ID="upContent" UpdateMode="Conditional" runat="server">
                    <ContentTemplate>
                        ...
                        <div runat="server" id="divRemoveUserStory" class="mainPopup" visible ="false">
                            <div runat="server" class="internalPopup">
                                <asp:Label ID="lblRemoveUserStoryMessage" runat="server" Text="" Width ="100%"></asp:Label>
                                <asp:Label ID="lblUserStoryId" Visible="false" runat="server" Text="" Width ="100%"></asp:Label>
                                <br />
                                <br />
                                <table>
                                <tr>
                                    <td><asp:Button ID="btnConfirmRemoveUserStory" runat="server" Text="Remove" CssClass="confirmRemove" Font-Bold="True" Font-Size="Medium" Width="140px"  OnClick="btnConfirmRemoveUserStory_Click" /></td>
                                    <td style="width:140px;"> </td>
                                    <td><asp:Button ID="btnCancelRemoveUserStory" runat="server" Text="Cancel" CssClass="cancelRemove" Font-Bold="True" Font-Size="Medium" Width="140px" OnClick="btnCancelRemoveUserStory_Click" /></td>
                                </tr>
                                </table>
                            </div>
                        </div>
                    ...
                    <Triggers>
                        ...
                        <asp:AsyncPostBackTrigger ControlID="btnConfirmRemoveUserStory" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnCancelRemoveUserStory" EventName="Click" />
                    </Triggers>
                </asp:UpdatePanel>
                <script type="text/javascript">
                    ...
                    function terminateProject(projectId, creatorId) {
                        pleaseWait();
                        if (confirm('Are sure you want to terminate the selected project?'))
                            terminateProjectConfirmed(projectId, creatorId);
                        else {
                            $(".modal").hide();
                        }
                    }
                    function terminateProjectConfirmed(projectId, creatorId) {
                        ...
                        $.ajax({
                            method: "POST",
                            url: '<%= ResolveUrl("ViewProject.aspx/terminateProject_Click") %>',
                            data: param,
                    ...
                    function removeProject(projectId, creatorId) {
                        pleaseWait();
                        if (confirm('Are sure you want to remove the selected project?'))
                            removeProjectConfirmed(projectId, creatorId);
                        else {
                            $(".modal").hide();
                        }
                    }
                    function removeProjectConfirmed(projectId, creatorId) {
                        console.log('You just confirmed!');
                        var projectID = parseInt(projectId);
                        var creatorID = parseInt(creatorId);
                        var obj = {
                        ...
                        $.ajax({
                            method: "POST",
                            url: '<%= ResolveUrl("ViewProject.aspx/removeProject_Click") %>',
                            data: param,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            async: true,
                    ...
                    function printProject(projectId) {
                        ...
                        var newWindow = window.open('PrintProject.aspx', '_blank');
                        console.log('Opened the print format in a new tab.');
                    }
                </script>
                <%--Content end--%>
            </div>
