<%@ Page Title="Create Project" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="CreateProject.aspx.cs" Inherits="Scrum.Accounts.Admin.CreateProject" %>
            ...
            <div class="panel-body">
                <table>
                    <tr>
                        ...
                        <td><asp:Label ID="lblTitleError" runat="server" Text="Invalid input: Please type the project name." Visible="false" ForeColor="red" Width="100%"></asp:Label></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><asp:Label ID="lblImageError" runat="server" Text="Image" Visible="false" ForeColor="red" Width="100%"></asp:Label></td>
                    </tr>
                    <tr>
                        ...
                        <td><asp:Label ID="lblStartDateError" runat="server" Text="calendar" Visible="false" ForeColor="red" Width="100%"></asp:Label></td>
                    </tr>
                    <tr>
